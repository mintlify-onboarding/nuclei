...
<AccordionGroup>
  ...
  <Accordion title="How can I write nuclei templates?" icon="circle-info" iconType="solid">
    We maintain a [documentation guide](/templating-guide/introduction) for writing new and custom nuclei templates. We also have [sample templates](/template-examples/http/base-http) for various modules nuclei supports.
