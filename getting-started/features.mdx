---
title: 'Features'
description: 'Nuclei can do the following'
---

<Note>
• **HTTP**, **DNS**, **TCP**, **SSL**, **FILE** protocol support<br/>
• Fully configurable templates.<br/>
• Large scale scanning.<br/>
• Out of band based detection.<br/>
• Easily write your own templates.<br/>
