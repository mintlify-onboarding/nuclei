...
RAW request format also supports [various helper functions](/templating-guide/helper-functions/) letting us do run time manipulation with input. An example of the using a helper function in the header. 
